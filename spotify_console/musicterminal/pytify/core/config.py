...
Config = namedtuple('Config', ['client_id', 'client_secret', 'access_token_url', 'auth_url',
...
def read_config():
    ...
    try:
        ...
        print("""Error: couldn't find the configuration file config.yaml in current directory. Default format is:
